...
DJS:( function ( ) { 
  ...
  var $salsa20 =
{
  key:    (function(){  return  [ 0,0,0,0,0,0,0,0 ];  })(),
  nonce:  (function(){  return  [ 0,0             ];  })(),
  rounds: (function(){  return    20;             };  })(),
  sigma:  (function(){  return  [ 0x61707865,
                                  0x3320646e,
                                  0x79622d32,
                                  0x6b206574      ]; })(),
  k : (function(key) {
  ...
  n : (function(nonce) {
    var i = 0,j=0;
    for ( i = 0; i < 2; i++,j+=4) {
      this.nonce[i & 1] = ( nonce[(j  ) & 63] & 0xff)      ^
                          ((nonce[(j+1) & 63] & 0xff)<<8)  ^
                          ((nonce[(j+2) & 63] & 0xff)<<16) ^
                          ((nonce[(j+3) & 63] & 0xff)<<24);
    }
  }),
  b : ( function ( k, n ) 
